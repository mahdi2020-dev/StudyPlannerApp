...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            // اضافه کردن گوش‌کننده رویداد برای دکمه ورود با گوگل
            var googleButton = document.getElementById('google-login-btn');
            if (googleButton) {
                googleButton.addEventListener('click', function(e) {
                    e.preventDefault();
                    console.log("کلیک روی دکمه ورود با گوگل");
                    // هدایت به آدرس ورود با گوگل
                    window.location.href = '/google-login';
                });
            } else {
                console.error("دکمه ورود با گوگل در صفحه پیدا نشد!");
            }
        };
...
<body>
    <div class="auth-container">
        ...
        <div class="social-login" style="text-align: center; margin-top: 20px; border-top: 1px solid #333; padding-top: 20px;">
            <p style="margin-bottom: 15px; color: #999;">با استفاده از:</p>
            
            <!-- دکمه ورود با گوگل -->
            <button id="google-login-btn" class="neon-button social-btn" style="background-color: #1a73e8; color: white; border: none; display: flex; align-items: center; justify-content: center; width: 100%; margin-bottom: 10px;">
                <svg width="18" height="18" viewBox="0 0 48 48" style="margin-left: 10px;">
        ...
        <!-- Guest Login Button -->
        <div class="guest-login-container" style="text-align: center; margin-top: 15px;">
